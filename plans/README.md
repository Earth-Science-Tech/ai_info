...
**Status legend:** `Not Started` â†’ `In-Progress` â†’ `Completed in Dev` â†’ `Completed in Production`
(plus `On Hold`, `Abandoned` when needed).

| Status | Plan | Project | Branch | Developers | Updated |
|--------|------|---------|--------|------------|---------|
| Completed in Production | [Affiliate Portal — invite-only affiliates, single-use QR codes → patient portal → MOCT visit (PR-A catalog groundwork + PR-B module)](affiliate-portal.md) | multi | feat/affiliate-catalog (eMed#851) + feat/affiliate-portal (eMed#852, carries Nick's Intake Form Map), feat/affiliate-catalog-schema (emed_sql#97) + feat/affiliate-portal-schema (emed_sql#98) — all four PRs MERGED, migrations applied to prod — shipped **1.0.359** 2026-09-17 | Mario Tabraue | 2026-09-17 |
| Completed in Production | [Pricing → Intake Form Map (global product → intake-form map + product images)](pricing-intake-form-map.md) | multi | `feat/pricing-intake-form-map` (shipped inside eMed#852 / emed_sql#98 — **1.0.359** 2026-09-17, prod-applied) | Nicholas Cardell, Mario Tabraue | 2026-09-17 |
...
| Completed in Production | [Portal-user add forms email the temporary password (My Facilities Â· portal My Team)](portal-team-emailed-temp-password.md) | emed_app | `feat/portal-team-emailed-temp-password` (emed_app#848, 1.0.358) | Nicholas Cardell | 2026-09-17 |
...
| Completed in Production | [Peak Now Patient-Portal Integration (webhooks, intake forms, embedded portal + SSO â€” ships DARK)](peaknow-portal-integration.md) | multi | `feat/peaknow-portal-integration` (1.0.241 â€¦ 1.0.348, 1.0.354, 1.0.355) | Nicholas Cardell | 2026-09-16 |
| Completed in Production | [ExternalRep â€” Blaze Orders access (read-only, clinic-scoped)](externalrep-blaze-orders.md) | emed_app | `feat/externalrep-blaze-orders` (1.0.239) | Nicholas Cardell | 2026-08-29 |
| Completed in Production | [Clarifications / Script Modal by-id â€” clinic-scope hardening (PHI IDOR)](clarifications-clinic-scope.md) | emed_app | `feat/clarifications-clinic-scope` (1.0.239) | Nicholas Cardell | 2026-08-29 |
...
| Completed in Production | [Facility Scope Unification (FacilityGroups)](facility-scope-groups.md) | multi | `feat/patient-portal-secure-messaging` (1.0.205â€“1.0.207, 1.0.211) | Nicholas Cardell | 2026-08-19 |
...
- [Patient Portal + Facility Groups â€” As-Built Briefing](../projects/emed-app/patient-portal-and-facility-groups.md)
  â€” consolidates the two plans above with the cross-cutting release history, incidents/lessons, and the
