...
|--------|------|---------|--------|------------|---------|
| Completed in Dev | [Affiliate Portal — invite-only affiliates, single-use QR codes → patient portal → MOCT visit (PR-A catalog groundwork + PR-B module)](affiliate-portal.md) | multi | feat/affiliate-catalog (eMed#851) + feat/affiliate-portal (eMed#852, carries Nick's Intake Form Map), feat/affiliate-catalog-schema (emed_sql#97) + feat/affiliate-portal-schema (emed_sql#98) — PRs OPEN, migrations pending prod | Mario Tabraue | 2026-09-17 |
| Completed in Dev | [Pricing → Intake Form Map (global product → intake-form map + product images)](pricing-intake-form-map.md) | multi | `feat/pricing-intake-form-map` (emed_app, merged to `dev`; emed_sql migration dev-applied, PENDING PROD) | Nicholas Cardell, Mario Tabraue | 2026-09-17 |
