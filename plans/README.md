...
| In-Progress | [Portal-user add forms email the temporary password (My Facilities · portal My Team)](portal-team-emailed-temp-password.md) | emed_app | `feat/portal-team-emailed-temp-password` | Nicholas Cardell | 2026-09-17 |
