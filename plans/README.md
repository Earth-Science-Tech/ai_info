...
| Completed in Production | [Peak Now Patient-Portal Integration (webhooks, intake forms, embedded portal + SSO — ships DARK)](peaknow-portal-integration.md) | multi | `feat/peaknow-portal-integration` (1.0.241 … 1.0.348, 1.0.354) | Nicholas Cardell | 2026-09-16 |
