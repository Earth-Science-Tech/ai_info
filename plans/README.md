...
| Completed in Production | [Portal-user add forms email the temporary password (My Facilities · portal My Team)](portal-team-emailed-temp-password.md) | emed_app | `feat/portal-team-emailed-temp-password` (emed_app#848, 1.0.358) | Nicholas Cardell | 2026-09-17 |
...
| Completed in Production | [Peak Now Patient-Portal Integration (webhooks, intake forms, embedded portal + SSO — ships DARK)](peaknow-portal-integration.md) | multi | `feat/peaknow-portal-integration` (1.0.241 … 1.0.348, 1.0.354, 1.0.355) | Nicholas Cardell | 2026-09-16 |
