...
|--------|------|---------|--------|------------|---------|
| Completed in Dev | [Affiliate Portal — invite-only affiliates, single-use QR codes → patient portal → MOCT visit (PR-A catalog groundwork + PR-B module)](affiliate-portal.md) | multi | `feat/affiliate-catalog` + `feat/affiliate-portal` (eMed, on `dev`; PRs to main held), `feat/affiliate-portal-schema` (emed_sql, 6 migrations pending prod) | Mario Tabraue | 2026-09-17 |
